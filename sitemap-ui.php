			...
			<form method="post" action="<?php echo $this->sg->GetBackLink() ?>">
				...
				?>
					...
					<?php if(is_super_admin()): ?>
						...
						<?php
							esc_html_e('Here you can specify files or URLs which are not generated by WordPress but should be included in the sitemap.<br />For example, if your domain is www.foo.com and your site is located on www.foo.com/site you might want to include your homepage at www.foo.com','sitemap');
							echo "<ul><li>";
